...
confirmed_cases_worldwide <- read_csv("datasets/confirmed_cases_worldwide.csv", col_types = cols(date = col_date(format = "%Y-%m-%d"), 
...
confirmed_cases_china_vs_world <- read_csv("datasets/confirmed_cases_china_vs_world.csv",col_types = cols(date = col_date(format = "%Y-%m-%d"), 
                                  cum_cases = col_double()))
...
confirmed_cases_by_country <- read_csv("datasets/confirmed_cases_by_country.csv", col_types = cols(
...
confirmed_cases_top7_outside_china <- read_csv("datasets/confirmed_cases_top7_outside_china.csv", col_types = cols(
                   country = col_character(),
                   date = col_date(format = "%Y-%m-%d"),
                   cum_cases = col_double()
                 ))
